...
| Planner / coaching backend | repo/runtime real; deployed truth unchanged | planner, templates/loadouts, and richer profile inputs are now real in repo/runtime, but deployed truth remains narrower | medium |
