...
| Analytics / ARES v2 | Deferred to Phase 3B.16 after rating/trust substrate | `apollo` | Result trust and legacy rating foundation exist, but OpenSkill dual-run and ARES v2 gates are not closed | OpenSkill dual-run and ARES v2 prerequisites are complete | No analytics-as-truth before rating trust; no ARES v2 before safe rating reads | Phase 3B.13 |
