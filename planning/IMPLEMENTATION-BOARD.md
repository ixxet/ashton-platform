...
0. APOLLO launch expansion fork, if chosen next
   ...
   - ATHENA Real Ingress Bridge is closed locally/runtime in ATHENA: the
     ...
     truth
   - the next launch-expansion packet is likely live destructive-probe/SIGTERM
     proof planning, depending on planning ruling
...
1. next Phase 3B planning fork after closed `Phase 3B.20`
   ...
   - Themis now owns the internal `/ops/bookings` staff workspace and
	...
	- 3B-LC smoke/stress closeout, Scale Gate Numeric Ceilings, CLI Demo
	  ...
	  closed as docs truth only. The next launch-expansion line should be live
	  destructive-probe/SIGTERM proof planning unless a hardening packet is
	  needed, and
