...
analytics, tournament runtime, public competition surfaces, CP/badges/rivalry/
squads, and game identity remain deferred.

The active next ladder is now post-`Phase 3B.15`:

| Order | Line | Repo focus | Purpose | Hard stop |
| --- | --- | --- | --- | --- |
| 1 | 3B.16 Competition Analytics Foundation | `apollo` | inspect trusted result/rating/ARES preview facts without public dashboards | no analytics-as-truth before rating trust or public stakes |
| 2 | tournament/public/game identity ladder | likely `apollo`, `themis`, then `hestia` only after gates | add tournament runtime, public competition readiness, and game identity in order | no public competition surface before privacy, result trust, rating, telemetry, scale, and compatibility gates |
